...
export default function PlaylistSong({ item,playlistName,id, onTrackSelect }: Songitem) {
    ...
    const rightActions = (swipeableRow: any) => {
        ...
        >
            <PlaylistMenu track={item} playlistName={playlistName} swipeableRow={swipeableRow}>
    ...
    return (
        ...
        >
            ...
            <TouchableHighlight onPress={() => onTrackSelect(item)}
                style={{ ...styles.contaner, width: '100%', backgroundColor: "#222" }}
            >
